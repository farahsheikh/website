...
<?php if (isset($enable_custom_layout) && $enable_custom_layout = 'enable' && $enable_custom_layout != 'disable') { ?>
    ...
    <style> 
        ...
        #<?php echo $random_id; ?> #template-1 .testim-image-resize img,
        #<?php echo $random_id; ?> #template-2 .testim-image-resize img,
        #<?php echo $random_id; ?> #template-3 .testim-image-resize img,
        #<?php echo $random_id; ?> #template-4 .testim-image-resize img,
        #<?php echo $random_id; ?> #template-5 .testim-image-resize img
        {
            width:<?php
