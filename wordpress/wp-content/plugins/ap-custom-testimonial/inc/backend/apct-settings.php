...
<div class="afct-option-setting-wrapper">
    ...
    <div class="apct-general-setting-section image-setting-section"> 
        ...
        <div class="apct-image-section">
            <input type="number" name="testim_image_width" placeholder="Ex@ 100" value="<?php
            if (isset($options['testim_image_width'])) {
                echo $options['testim_image_width'];
            }
            ?>" /><br />
        ...
        <div class="apct-image-section">
            ...
            <input type="text" name="testim_img_brdr_color" class="apct-color-field" value="<?php
            if (isset($options['testim_img_brdr_color'])) {
                echo $options['testim_img_brdr_color'];
            }
            ?>"  />
        </div>
        ...
        <div class="apct-image-section">
            ...
            <input type="number" name="testim_img_brdr_width" placeholder="Ex@ 2" value="<?php
            if (isset($options['testim_img_brdr_width'])) {
                echo $options['testim_img_brdr_width'];
            }
            ?>"  /><br />
        ...
        <div>
            ...
            <input type="number" name="testim_image_radius" placeholder="Ex@ 50" class="testim-image-radius" value="<?php
            if (isset($options['testim_image_radius'])) {
                echo $options['testim_image_radius'];
            }
            ?>" /><br />
    ...
    <div class="apct-general-setting-section color-setting-section"> 
        ...
        <div class="color-setting-op">
            ...
            <input type="text" name="testim_bg_color" id="testim_bg_color" value="<?php
            if (isset($options['testim_bg_color'])) {
                echo $options['testim_bg_color'];
            }
            ?>"  />
        </div>
        ...
        <div class="color-setting-op">
            ...
            <input type="text" id="testim_author_title_color" name="testim_author_title_color" value="<?php
            if (isset($options['testim_author_title_color'])) {
                echo $options['testim_author_title_color'];
            }
            ?>"  />
        </div>
    </div>
    <div class="apct-general-setting-section typography-setting-section"> 
        ...
        <div>
            ...
            <input type="number" id="testim_font_size" name="testim_font_size" placeholder="Ex@ 22px" value="<?php
            if (isset($options['testim_font_size'])) {
                echo $options['testim_font_size'];
            }
            ?>" /><br />
